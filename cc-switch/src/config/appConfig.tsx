...
export const WELLAU_VISIBLE_APP_IDS: AppId[] = APP_IDS.filter(
  (id) => wellauBrand.defaultVisibleApps[id],
);
...
export const WELLAU_VISIBLE_SKILLS_APP_IDS: AppId[] = SKILLS_APP_IDS.filter(
  (id) => wellauBrand.defaultVisibleApps[id],
);
...
export const WELLAU_VISIBLE_MCP_APP_IDS: AppId[] = MCP_APP_IDS.filter(
  (id) => wellauBrand.defaultVisibleApps[id],
);
