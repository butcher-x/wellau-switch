...
const VISIBLE_USAGE_APP_TYPES = KNOWN_APP_TYPES.filter(
  (type) =>
    wellauBrand.defaultVisibleApps[
      type as keyof typeof wellauBrand.defaultVisibleApps
    ],
);

const APP_FILTER_OPTIONS: AppTypeFilter[] = [
  "all",
  ...VISIBLE_USAGE_APP_TYPES,
];
