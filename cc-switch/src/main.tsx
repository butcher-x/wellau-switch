...
import { WellauAuthProvider } from "@wellau/auth/WellauAuthProvider";
import { WellauFirstRunGate } from "@wellau/onboarding/WellauFirstRunGate";
...
async function handleConfigLoadError(
  ...
  const path = payload?.path ?? wellauBrand.configDisplayPath;
  ...
  ReactDOM.createRoot(document.getElementById("root")!).render(
    <React.StrictMode>
      <QueryClientProvider client={queryClient}>
        <ThemeProvider
          defaultTheme="system"
          storageKey={wellauBrand.themeStorageKey}
        >
          <UpdateProvider>
            <WellauAuthProvider>
              <WellauFirstRunGate>
